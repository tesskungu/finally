  ...
  return (
    <div className="panel p-5 space-y-4 animate-fade-in">
      ...
      <Accordion type="multiple" className="w-full">
        {/* Transform Controls - Scale and Rotation */}
        ...
        {/* Adjustment Controls - Brightness and Contrast */}
        ...
        {/* Color Controls - Background and Product Color */}
              ...
              <div className="control-group">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      updateSetting("productColor", e.target.value)
                    }
                    className="w-full h-10 rounded cursor-pointer border border-gray-700"
